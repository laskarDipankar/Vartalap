...
const createChat = async (request: AuthenticateRequest, reply: FastifyReply) => {
...
const fetchApi = async (request: AuthenticateRequest, reply: FastifyReply) => {
...
const fetchChat = async (request: AuthenticateRequest, reply: FastifyReply) => {
...
const creatGroupChat = async (request: AuthenticateRequest, reply: FastifyReply) => {
    
        const{chatName,alluser} :any = request.body;
...
const renameGroupChat = async (request: AuthenticateRequest, reply: FastifyReply) => {
    
    const {chatId,chatName} : any = request.body;
    if(!chatId || !chatName){
        return reply.send({
            code:400,
            error : "send all the required data"})
...
const addMembers = async (request: AuthenticateRequest, reply: FastifyReply) => {

    const admin = request.user._id;

    const {chatId,alluser} : any = request.body;
    if(!chatId || !alluser){
        return reply.send({
            code:400,
...
const removeMemebers = async (request: AuthenticateRequest, reply: FastifyReply) => {
